...
~~~sh
git clone git@github.com:nko3/challenger-io.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-challenger-io --password +wxBxrtv2dHBKEA5
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/challenger-io" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280743
[3]: https://github.com/nko3/challenger-io
